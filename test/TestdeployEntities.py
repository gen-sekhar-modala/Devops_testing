...
#        TARGET_PROJECT_NAME = data_json["TARGET_PROJECT_NAME"]
        #import os
        #ENTITY_TYPE='VIEW'&DATASET_NAME='Example_dataset1_stg'&TARGET_DATASET_NAME='Example_dataset1'&ENTITY_NAME='Emp_details_view'&TARGET_PROJECT_NAME='data-engineering-gcp-practice'&SOURCE_PROJECT_NAME='data-engineering-gcp-practice'
        ENTITY_TYPE='VIEW'
        DATASET_NAME='Example_dataset1_stg'
        TARGET_DATASET_NAME='Example_dataset1'
        ENTITY_NAME='Emp_details_view'
        TARGET_PROJECT_NAME='data-engineering-gcp-practice'
        SOURCE_PROJECT_NAME='data-engineering-gcp-practice' 
